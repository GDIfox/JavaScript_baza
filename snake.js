...
const snake = {
  ...
  growUp() {
    ...
    document.querySelector('p').innerHTML = `Змейка по "хомячила" ${++game.score} раз, 
      еще осталось по "хомячить" чтобы лопнуть ${settings.winFoodCount - game.score}`
  ...
  getNextStepHeadPoint() {
    ...
    switch (this.direction) {
      //  Убрать границы поля. 
      //  Т.е. при пересечении границы поля змейка появляется с противоположной стороны.
      case 'up':
